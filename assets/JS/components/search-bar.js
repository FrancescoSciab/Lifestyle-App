...
export const searchBar = $("input").on("input", function(){
        ...
        inputTimeout = setTimeout(function() {
            ...
            const formattedCityInput = cityInput.toLowerCase().split(" ").join("-");
            ...
            try{
                ...
                }).fail (function(){ //errors that occur during the AJAX request
                    const fail = $("<p/>", {
